...
data1 = pd.read_csv('../検証用データ/data1_6_1.csv',sep=',')#csvファイルを読み込んだ一番上の行をラベルと認識してくれる 
data2 = pd.read_csv('../検証用データ/data1_6_2.csv',sep=',')#csvファイルを読み込んだ一番上の行をラベルと認識してくれる 
data3 = pd.read_csv('../検証用データ/data1_6_3.csv',sep=',')#csvファイルを読み込んだ番上の行をラベルと認識してくれる 
