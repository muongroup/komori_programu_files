...
void atten_hist31_xyhalf(){
  gStyle->SetPadRightMargin(0.15);
  gStyle->SetPalette(1);
   

  TCanvas *cvs1=new TCanvas("background","background",900,900);//TCanvasを用いることでいくつものグラフを一斉に表示できる 
  std::ifstream back("back_compress_xyhalf.txt");//バックグラウンドのデータ                                                                                                                                              
  TH2D *background =new TH2D("background measurement","",15,-7.5,7.5,15,-7.5,7.5);//バックグラウンドデータをプロット  
  ...
  TH2D *object =new TH2D("object measument","",15,-7.5,7.5,15,-7.5,7.5);//                                                                                                        
 ...
 TCanvas *cvs3=new TCanvas("substraction","substraction",900,900);
  TH2D *substraction =new TH2D("substraction ","",15,-7.5,7.5,15,-7.5,7.5);
 ...
 TH2D *attenuation =new TH2D("attenuation rate","",15,-7.5,7.5,15,-7.5,7.5);
 ...
 TH2D *attenuation2 =new TH2D("attenuation rate","",15,-7.5,7.5,15,-7.5,7.5);
 ...
 TCanvas *cvs6=new TCanvas("back_error","back_error",900,900);
  TH2D*back_error =new TH2D("back_error","",15,-7.5,7.5,15,-7.5,7.5);
  double error_valueb;
  ...
  TH2D*object_error =new TH2D("object_error","",15,-7.5,7.5,15,-7.5,7.5);
   ...
   for(int i=1;i<16;i++)
     {
	   ...
	   object_error->Fill(i-8,j-8,error_valueo);
	 }
     }
   ...
   TH2D*attenuation_error =new TH2D("attenuation_error","",15,-7.5,7.5,15,-7.5,7.5);
   ...
   for(int i=1;i<16;i++)
     {
	   ...
	   attenuation_error->Fill(i-8,j-8,error_attenuation);
	 }
     }
