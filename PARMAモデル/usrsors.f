...
! Input parameters, if you would like to change the conditions, please revise these parameters
      data r0/12000/   ! Radius of Source Surface
      data ip/29/ ! Particle ID (Particle ID, 0:neutron, 1-28:H-Ni, 29-30:muon+-, 31:e-, 32:e+, 33:photon)     
      data iyear/2017/  ! Year
      data imonth/1/    ! Month
      data iday/1/      ! Date
      data glat/30d0/   ! Latitude (deg), -90 =< glat =< 90
      data glong/31d0/ ! Longitude (deg), -180 =< glong =< 180
      data Alti/0.02d0/   ! Altitude (km)
...
! Set energy and angle ranges for generation
       ...
       amin = -1.00   ! Minimum cosine of particle
